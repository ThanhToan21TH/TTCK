...
<head>
	...
	<title>Trang quản trị - Diamond Express</title>
...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Diamond Express</span>
        </a>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item <?php if(strpos($_SERVER['REQUEST_URI'],"qldichvu") != false) echo "active"; ?>">
						<a class="sidebar-link" href="../qldichvu/index.php">
						<i class="align-middle" data-feather="grid"></i> <span class="align-middle">Quản lý dịch vụ</span>
						</a>
					</li>

					<li class="sidebar-item <?php if(strpos($_SERVER['REQUEST_URI'],"qldonvan") != false) echo "active"; ?>">
						<a class="sidebar-link" href="../qldonvan/index.php">
						<i class="align-middle" data-feather="package"></i> <span class="align-middle">Quản lý đơn vận</span>
						</a>
					</li>		
					<li class="sidebar-item <?php if(strpos($_SERVER['REQUEST_URI'],"qlblog") != false) echo "active"; ?>">
						<a class="sidebar-link" href="../qlblog/index.php">
						<i class="align-middle" data-feather="clipboard"></i> <span class="align-middle">Quản lý tin tức</span>
						</a>
					</li>						
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="../image">
