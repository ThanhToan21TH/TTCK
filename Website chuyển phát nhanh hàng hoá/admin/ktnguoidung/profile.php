        ...
        <div class="card-body">
          <form method="post" enctype="multipart/form-data" action="../ktnguoidung/index.php">
            ...
            <div class="text-center">
              <img class="img-thumbnail" src="<?php if ($_SESSION["nguoidung"]["hinhanh"]==NULL) echo "../../image/users/user.png"; else echo "../../image/users/" . $_SESSION["nguoidung"]["hinhanh"]; ?>" alt="<?php echo $_SESSION["nguoidung"]["hoten"]; ?>" width="100px">
            </div>
            <input type="hidden" name="txtid" value="<?php echo $_SESSION["nguoidung"]["id"]; ?>">
            <div class="my-3">    
