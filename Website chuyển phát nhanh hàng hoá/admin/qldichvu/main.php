...
<table class="table table-hover">
	<tr><th>ID</th><th>Tên dịch vụ</th><th>Sửa</th><th>Xóa</th></tr>
	<?php 
	foreach ($dichvu as $d) : 
	...
	?>
		...
		<form method="post">
			...
			<td><?php echo $d["id"]; ?></td>
			<td><input class="form-control" name="ten" type="text" value="<?php echo $d["tendichvu"]; ?>"></td>
